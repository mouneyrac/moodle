...
$string['coursefile_help'] = 'This file must be a CSV file.<br/>
<a href="http://docs.moodle.org/26/en/admin/tool/uploadcourse/index#Short_file_example">See the Moodledocs</a>.';
...
$string['csvdelimiter_help'] = 'CSV delimiter of the picked CVS file.';
...
$string['encoding_help'] = 'Encoding of the picked CVS file.';
...
$string['rowpreviewnum_help'] = 'Number of rows from the CVS file that will be previewed in the next page. This option exists in
