...
/**
 * Strings for component 'auth_oauth2facebook', language 'en'
 *
 * @package   auth_oauth2facebook
...
1) Go to {$a->link}.<br/>
2) Create a new app. Your site url is {$a->siteurl} and your site domain is {$a->domain}.<br/>
3) Copy the generated App ID and APP Key below and save.
';
$string['appspage'] = 'your Facebook apps page';
