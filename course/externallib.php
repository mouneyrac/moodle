                    ...
                    'modules' => new external_multiple_structure(
                            new external_single_structure(
                                array(
                                    ...
                                    'availablefrom' => new external_value(PARAM_FLOAT, 'module availability start date', VALUE_OPTIONAL),
                                    'availableuntil' => new external_value(PARAM_FLOAT, 'module availability en date', VALUE_OPTIONAL),
                                    ...
                                    'contents' => new external_multiple_structure(
                                          new external_single_structure(
                                              array(
                                                  ...
                                                  'timecreated' => new external_value(PARAM_FLOAT, 'Time created'),
                                                  'timemodified' => new external_value(PARAM_FLOAT, 'Time modified'),
        ...
        return new external_multiple_structure(
                new external_single_structure(
                        array(
                            ...
                            'startdate' => new external_value(PARAM_FLOAT,
                            ...
                            'defaultgroupingid' => new external_value(PARAM_INT, 'default grouping id',
                                    VALUE_OPTIONAL),
                            'timecreated' => new external_value(PARAM_FLOAT,
        ...
        return new external_multiple_structure(
            new external_single_structure(
                array(
                    ...
                    'timemodified' => new external_value(PARAM_FLOAT, 'timestamp', VALUE_OPTIONAL),
