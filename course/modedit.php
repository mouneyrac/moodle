...
if (!empty($add)) {
    ...
    list($module, $context, $cw) = can_add_module($course, $add, $section);
...
if ($mform->is_cancelled()) {
    ...
    if (!empty($fromform->update)) {
        list($cm, $fromform) = update_module($cm, $fromform, $course, $mform);
    } else if (!empty($fromform->add)) {
        $fromform = add_module($fromform, $course, $mform);
    } else {
