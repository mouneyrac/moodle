...
class courseexternallib_testcase extends advanced_testcase {
    ...
    public function test_delete_categories() {
        ...
        //TODO: delete_categories() will most likely throw an exception if
        //      we tried to delete a function that was previously deleted by recursivity
...
//                'descriptionformat' => FORMAT_HTML,
        ...
        //TODO: update_categories should let the dev change the parent to root
...
//        $this->assertEquals(FORMAT_HTML, $dbcategories[$category1->id]->descriptionformat);
    ...
    public function test_create_courses() {
        ...
        //TODO: create_courses() => if the user has not 'moodle/course:visibility' then
        //      the function should throw an execption
        ...
        foreach($createdcourses as $createdcourse) {
            ...
            if ($createdcourse['shortname'] == $course2['shortname']) {
                ...
                $this->assertEquals($dbcourse->summaryformat, FORMAT_MOODLE);
    ...
    public function test_get_courses () {
        ...
        $this->assertEquals($courses[0]['summaryformat'], $coursedata['summaryformat']);
    ...
    public function test_get_course_contents() {
        ...
        $this->assertEquals(3, count($courses['modules']));
    }
    ...
    public function test_duplicate_course() {
        ...
        $courses = core_course_external::duplicate_course($course->id, $newcourse['fullname'],
