        ...
        return new external_multiple_structure(
            new external_single_structure(
                array(
                    ...
                    'firstaccess' => new external_value(PARAM_FLOAT, 'first access to the site (0 if never)', VALUE_OPTIONAL),
                    'lastaccess'  => new external_value(PARAM_FLOAT, 'last access to the site (0 if never)', VALUE_OPTIONAL),
