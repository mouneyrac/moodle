...
$string['timezonesecuritywarning'] = 'The timezone has been detected to be set to \'Server default\'. \'Server default\' can sometimes result in strange calendar event times. It is recommended to choose a proper timezone. {$a->import} then {$a->defaulttz}.';
$string['timezonechange'] = 'change default timezone';
$string['timezoneimport'] = 'Update timezones';
