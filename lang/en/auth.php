...
$string['accountalreadylinked'] = 'Your account is already linked to another account on this site.';
...
$string['auth_nomailrestriction'] = 'No email domain restriction';
$string['auth_nomailrestriction_help'] = 'By pass the global denied/allowed email addresses options  (i.e. denyemailaddresses/allowemailaddresses).';
...
$string['auth_createuser'] = 'Create accounts';
$string['auth_createuser_help'] = 'Create a new account when no account can be matched.';
$string['auth_createuserconfirm'] = 'Confirm unmatched email';
$string['auth_createuserconfirm_help'] = 'During authentication if the email address could not be matched, the user is alerted.
The user can decide to create a new account or link an existing account. This alert is useful to avoid duplicate accounts. When this setting is disabled
a new account will be created for any unmatched email address. User can resolved duplicated accounts in My profile settings > Authentication.';
...
$string['auth_userprefix_help'] = 'If the user email sent by {$a->pluginname} isn\'t registered, then the site creates a new user with username "{$a->userprefix}XXX", XXX being incremented every time. You can change the username prefix if it conflicts with anything else in your Moodle. On a basic Moodle site you don\'t need to change it.';
$string['auto_add_remote_users'] = 'Auto add remote users';
$string['createpassword'] = 'Generate password and notify user';
$string['couldnotgetaccesstoken'] = 'The authentication provider sent us a communication error. Please try to sign-in again.';
$string['createpasswordifneeded'] = 'Create password if needed';
$string['editmyauthentication'] = 'Authentication';
$string['emailaddressmustbeverified'] = 'Your email address is not verified by the social network you selected. You likely have forgotten to click on a "verify email address" email link during your subscribtion to the selected social network.';
...
$string['existingaccount'] = 'I have an account, log me in first.';
...
$string['doyouhaveanaccount'] = 'Your email address is not linked to an account in our database.';
...
$string['linkaccount'] = 'Link my account with:';
$string['linkedproviders'] = 'Your account is linked with: {$a}';
$string['linkingaccount'] = 'Link an external account';
$string['linkproviders'] = 'Click an authentication provider to link it to your account.';
$string['locked'] = 'Locked';
$string['md5'] = 'MD5 hash';
$string['newaccount'] = 'I want a new account.';
$string['nolinkedproviders'] = 'No providers are linked to your account';
...
$string['oauth2loginrequired'] = 'Your email address is not linked to an account in our database.';
...
$string['primaryauth'] = 'Primary authentication';
...
$string['secondaryauths'] = 'Secondary authentications';
