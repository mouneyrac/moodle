...
$string['existingaccount'] = 'Yes, log me in first:';
...
$string['doyouhaveanaccount'] = 'Do you already have an account?';
...
$string['linkedproviders'] = 'Linked network(s) to your account: {$a}';
$string['linkingaccount'] = 'Link an external account';
$string['locked'] = 'Locked';
$string['md5'] = 'MD5 hash';
$string['newaccount'] = 'No, create a new account and link it with: ';
