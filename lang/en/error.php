...
$string['userinvalidauth'] = 'Invalid authentication type: {$a->auth} for user: {$a->username}';
$string['userinvalidlang'] = 'Invalid language code: {$a->lang} for user: {$a->username}';
$string['userinvalidproperty'] = 'Property: {$a->key} is too long: {$a->value} for user: {$a->username}';
$string['userinvalidtheme'] = 'Invalid theme: {$a->theme} for user: {$a->username}';
$string['usermustbemnet'] = 'Users in the MNET access control list must be remote MNET users';
$string['usernamealreadyused'] = 'Username already exists: {$a}';
