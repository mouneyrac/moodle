...
$string['cannotupdatehubinfo'] = 'Cannot update {$a->hubname} information (error: {$a->error})';
...
$string['updatehubmissingvalues'] = 'You called get_updated_hub_info() function without id/token/url';
