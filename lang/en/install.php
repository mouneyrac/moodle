...
$string['removemymobilewarning']= '"My Mobile" theme files have been removed. "My Mobile" theme will be uninstalled and all "My Mobile" theme settings will be deleted. "My Mobile" theme will fallback to the "Clean" theme. If you wish to keep "My Mobile" theme, you can copy back the files from the Moodle.org plugins repository, see MDLSITE-2494.';
