...
$string['addoauthtoken'] = 'Add OAuth token';
...
$string['configoauthrsakey'] = 'This is the key that will be used to sign OAuth requests when using RSA signatures.';
$string['configwebserviceplugins'] = 'For security reasons, only protocols that are in use should be enabled.';
$string['context'] = 'Context';
$string['createoauthcredentials'] = 'Create OAuth credentials';
...
$string['deleteoauthcredentialsconfirm'] = 'Do you really want to delete the OAuth credentials for <strong>{$a->user}</strong> on the service <strong>{$a->service}</strong>?';
...
$string['incorrectsignmethod'] = 'Incorrect signature method';
...
$string['manageoauthcredentials'] = 'Manage OAuth credentials';
...
$string['oauth_plaintext'] = 'Plain text (requires HTTPS)';
$string['oauth_hmac_sha1'] = 'HMAC-SHA1';
$string['oauth_hmac_sha256'] = 'HMAC-SHA256';
$string['oauth_rsa_sha1'] = 'RSA-SHA1';
$string['oauth'] = 'OAuth';
$string['oauthcredentials'] = 'OAuth credentials';
$string['oauthrsapublickey'] = 'RSA public key';
$string['oauthrsakey'] = 'OAuth RSA key';
$string['oauthsecretdisplay'] = 'The shared secret corresponding to the identifier "{$a->identifier}" for {$a->firstname} {$a->lastname} is:

<blockquote>{$a->secret}</blockquote>

Please ensure that this secret is kept private.';
$string['oauthsignmethod'] = 'Signature method';
$string['oauthsignmethod_help'] = 'How to verify that the request is coming from the right client.  Plain text requires that both servers can use HTTPS.  All methods other than RSA-SHA1 use a shared secret, which must not be revealed publicly.  RSA-SHA1 (not supported yet) uses an RSA key, where the public half may be revealed publicly.  Of the methods that use a shared secret, HMAC-SHA256 is the most secure, but may not be supported by all clients.  Plain text is the simplest, but requires that the requests are transferred via HTTPS to ensure security.';
