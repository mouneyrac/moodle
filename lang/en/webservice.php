...
$string['usernameorid_help'] = 'Enter the username or userid of the user to link to the token.';
$string['usernameoridnousererror'] = 'No users match this username/id.';
$string['usernameoridoccurenceerror'] = 'More than one user match this username. Search by user id.';
