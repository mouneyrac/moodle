...
class moodle_mobile extends external_api {
    public static function moodle_echo_parameters() {
    ...
    function moodle_echo($msg) {
        return array(array('sitename'=>'dongsheng moodle', 'siteurl'=>'http://moodle.org'), array('sitename'=>'abc', 'siteurl'=>'http://moodle.net'));
    }
    public static function moodle_echo_returns() {
        return new external_multiple_structure(
            new external_single_structure(
                array(
                    'sitename'    => new external_value(PARAM_RAW, 'ID of the user'),
                    'siteurl'    => new external_value(PARAM_RAW, 'Username policy is defined in Moodle security config'),
                )
            )
        );
    }
    ...
    function get_siteinfo($msg) {
        ...
        return array(
            ...
            'profilepicture' => base64_encode($file->get_content()),
        );
    }
    public static function get_siteinfo_returns() {
        return new external_single_structure(
            array(
                ...
                'profilepicture' => new external_value(PARAM_RAW, 'current user profile picture'),
            )
        );
    }
}
