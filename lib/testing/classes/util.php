...
abstract class testing_util {
     ...
     *
     * @param $dataroot the dataroot of the test framework.
     */
    ...
    public static function reset_dataroot() {
        ...
        error_log(print_r($childclassname::$datarootskiponreset, true));
        if (self::get_dataroot() != $CFG->dataroot) {
            //die();
        }
