...
DIALOGUE = function(config) {
    ...
    config.center =     config.centered !== false;
            ...
            if (!e.prevVal && e.newVal) {
                ...
                if (!this.shouldResizeFullscreen()) {
                    if (this.get('draggable')) {
                        ...
                        draggablehandles.push(titlebar);
                        if (this.get('draggablecontent')) {
                            content = '#' + this.get('id') + ' .' + CSS.CONTENT;
                            draggablehandles.push(content);
                        }
                        this.plug(Y.Plugin.Drag, {handles : draggablehandles});
