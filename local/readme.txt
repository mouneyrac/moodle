...
from /local/xxx/db/services.php and are automatically installed/updated in Moodle.
...
You will need to write the /local/xxx/externallib.php - external functions
