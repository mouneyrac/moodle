@assignfeedback_editpdf @_only_local
Feature: In an assignment, teacher can annotate PDF files during grading
  ...
  Scenario: Submit a PDF file as a student and annotate the PDF as a teacher
    ...
    Then I should see "The ghostscript path appears to be OK"
    And I log out
    And I log in as "student1"
    And I follow "Course 1"
    And I follow "Test assignment name"
    When I press "Add submission"
    And I upload "mod/assign/feedback/editpdf/tests/fixtures/submission.pdf" file to "File submissions" filepicker
    And I upload "mod/assign/feedback/editpdf/tests/fixtures/testgs.pdf" file to "File submissions" filepicker
    And I press "Save changes"
    ...
    And I click on "Grade" "link" in the "Submitted for grading" table row
    And I follow "Launch PDF editor..."
    And I click on "//*[@class=\"navigate-next-button\"]" "xpath_element"
    And I click on "//*[@class=\"stampbutton\"]" "xpath_element"
    And I click on "//*[@class=\"linebutton\"]" "xpath_element"
    And I click on "//*[@class=\"commentcolourbutton\"]" "xpath_element"
