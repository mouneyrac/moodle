...
//        var ancestorscrollheight = node.ancestor().get('scrollHeight'),
        ...
        console.log(parseInt(node.getStyle('height'), 10));
        console.log(node.get('scrollHeight'));
//        console.log(parseInt(node.ancestor().getStyle('height'), 10));
//        console.log(node.ancestor().get('scrollHeight'));
//        console.log(parseInt(node.ancestor().ancestor().getStyle('height'), 10));
//        console.log(node.ancestor().ancestor().get('scrollHeight'));

        // Webkit ancestorscrollheight fix.
        var ancestorscrollheight = node.ancestor().get('scrollHeight');
        if (node.get('scrollHeight') === (height + 8)) {
            ancestorscrollheight -= 8;
            console.log('I am in webkit and fixingthe problem');
        }
        menu.setStyles({
